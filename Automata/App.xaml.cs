...
using Automata.Notifications;
using Automata.Plugins;
using Automata.Services;
using Automata.Services.EventAggregator;
using Automata.ViewModels;
using Automata.Views;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<WorkflowsPage2>();
    ...
    {
        CoreServices.Install(Host.Services);

        base.OnLaunched(args);

        App.GetService<PluginManager>().DiscoverPluginsInFolder(AppContext.BaseDirectory);
        App.GetService<IMessenger>().SetMainThreadSynchronizationContext(SynchronizationContext.Current);
