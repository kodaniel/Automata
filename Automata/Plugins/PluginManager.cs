...
public sealed class PluginManager
{
    ...
    public PluginManager(AutomataController automataController)
    {
        _controller = automataController;
    }

    public void DiscoverPluginsInFolder(string pluginFolderPath)
    {
        ...
        foreach (var dllFile in Directory.GetFiles(pluginFolderPath, "Automata.Plugin.*.dll"))
        {
            ...
            AddPluginFromAssembly(assembly);
        }
    }

    public void AddPluginFromAssembly(Assembly assembly)
    {
